...
from app.routers import classificacao, convocacoes, health, inscricoes, painel, processos, unidades
...
for r in (health, processos, unidades, inscricoes, classificacao, convocacoes, painel):
