...
from app.routers import (chat, classificacao, convocacoes, familia, geo, health, inscricoes, motor, painel,
                         processos, unidades)
...
for r in (health, processos, unidades, inscricoes, classificacao, convocacoes, painel, familia, chat, geo, motor):
